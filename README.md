...
## Instalación d'apache2, mysql i algunas librerias al contenedor
...
Después de el paso anterior, ponemos el siguiente comando:**LC_ALL=C.UTF-8 sudo add-apt-repository ppa:ondrej/php -y**
...
Después de esto, como tenemos que usar la versión 7.4, escribiremos la letra 2, en referéncia a el número que nos sale antes para meter la versión 7.4 y después de eso, le damos a enter.

![Text alternatiu](Polish_20241110_155934506.jpg)

6.Activamos los módulos de apache2 necesarios

Tendremos que poner dós codigos en nuestro terminal, el primero será: **sudo a2enmod proxy_fcgi setenvif**
...
1.Sudo cp a el archivo

El primer paso será poner el comando que dejaré abajo del texto en el terminal, siempre y cuando hayas descargado el archivo, ten en cuenta que si no tienes el ordenador en español, tendrás que canviar el nombre de **Descargas** por como se llame la carpeta para descargar archivos en el idioma en el que lo estás usando.
...
En mi caso, me sale la opción de remplazar, pero esto me paso debido a que ya lo hice en otro momento, pero si es tu primera vez no te saldrá eso, aunque si te llega a salir ese mensaje por cualquier motivo, con darle al botón **ctrl** y luego a la letra **c** saldrás de ahí y podrás volver a escribir en el terminal para seguir escribiendo comandos.
...
Después de todo esto, pondremos tres comandos de manera seguida, el primer comando es: **cd /var/www/html**, esto comando lo utilizamos para dirigirnos hacia esa carpeta.
